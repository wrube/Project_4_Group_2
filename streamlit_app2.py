...
def main():
    ...
    if option == "Make a prediction":
        ...
        st.markdown("This page allows you to make a prediction on a specific transaction by entering the row index. You can view the prediction result and the details of the selected row.")
